...
public class VolunteerProfileActivity extends AppCompatActivity {
    ...
    private void showProfileRecyclerView() {
        ...
        profileReference.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                volunteerProfileAdapter = new VolunteerProfileAdapter(VolunteerProfileActivity.this, profileList, queryDocumentSnapshots.size());
                rcvProfile.setAdapter(volunteerProfileAdapter);
                rcvProfile.setLayoutManager(new LinearLayoutManager(VolunteerProfileActivity.this));
            }
        });
    ...
    private  void showCreateSuccessMessage(){
        ...
        if (intent.hasExtra("recordCreated")){
            ...
            Utility.showInformationDialog(CREATE_RECORD_SUCCESS_TITLE,
                    CREATE_VOLUNTEER_PROFILE_SUCCESS_MSG , VolunteerProfileActivity.this);
        }
    }
    ...
    private void showUpdateSuccessMessage(){
        ...
        if (intent.hasExtra("recordUpdate")){
         Utility.showInformationDialog(UPDATE_RECORD_SUCCESS_TITLE, UPDATE_RECORD_SUCCESS_MSG, VolunteerProfileActivity.this);
        }
    }
}