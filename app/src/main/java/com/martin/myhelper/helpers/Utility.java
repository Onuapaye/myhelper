...
public class Utility extends Activity {
    ...
    public static final String INVALID_EMAIL_MSG = "Invalid e-mail address entered. The e-mail should be Gmail,  Yahoo, Hotmail, or Outlook and should include @ character";
